...
// @generated from file socket.proto (package socket, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
/**
 * @generated from message socket.SocketEvent
 */
export class SocketEvent extends Message<SocketEvent> {
  /**
   * any message_data = 2;
   *
   * @generated from field: socket.SocketEventType event_type = 1;
   */
